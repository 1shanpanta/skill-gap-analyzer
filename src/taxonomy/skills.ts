...
export const SKILL_TAXONOMY: TaxonomyEntry[] = [
  ...
  // ── Frontend Frameworks ──
  { canonical: 'React', category: 'framework', synonyms: ['react', 'reactjs', 'react', 'react js'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Next', category: 'framework', synonyms: ['nextjs', 'next', 'next js'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Vue', category: 'framework', synonyms: ['vue', 'vuejs', 'vue', 'vue3', 'vue 3', 'vue 2'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Nuxt', category: 'framework', synonyms: ['nuxt', 'nuxtjs', 'nuxt'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Angular', category: 'framework', synonyms: ['angular', 'angularjs', 'angular', 'angular 2+'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Svelte', category: 'framework', synonyms: ['svelte', 'sveltejs', 'sveltekit'], relatedGroup: 'frontend-frameworks' },
  { canonical: 'Solid', category: 'framework', synonyms: ['solidjs', 'solid', 'solid js'], relatedGroup: 'frontend-frameworks' },
  ...
  // ── Backend Frameworks ──
  { canonical: 'Node', category: 'framework', synonyms: ['node', 'nodejs', 'node', 'node js'], relatedGroup: 'node-web-frameworks' },
  { canonical: 'Express', category: 'framework', synonyms: ['express', 'expressjs', 'express'], relatedGroup: 'node-web-frameworks' },
  { canonical: 'NestJS', category: 'framework', synonyms: ['nestjs', 'nest', 'nest'], relatedGroup: 'node-web-frameworks' },
